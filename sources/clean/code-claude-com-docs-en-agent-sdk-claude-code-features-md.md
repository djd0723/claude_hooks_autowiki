---
type: source
source_url: https://code.claude.com/docs/en/agent-sdk/claude-code-features.md
title: "Use Claude Code features in the SDK"
raw_capture: ../raw/code-claude-com-docs-en-agent-sdk-claude-code-features-md.md
captured: 2026-06-29
---
